...
<div class="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
    ...
    <form action="{{ route('categorias.store') }}" method="POST" class="space-y-6 bg-white p-6 rounded-lg shadow-md">
        @csrf
        ...
        <div class="flex justify-between items-center">
              <a href="{{ route('categorias.index') }}" class="text-blue-600 hover:underline">← Volver</a>  
